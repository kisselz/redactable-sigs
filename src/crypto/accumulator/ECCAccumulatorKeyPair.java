 ...
 * @author Zach Kissel
 */
public class ECCAccumulatorKeyPair
{
  ECCAccumulatorPrivateKey sk;
  ECCAccumulatorPublicKey pk;
   ...
   */
  public ECCAccumulatorKeyPair(ECCAccumulatorPrivateKey sk, ECCAccumulatorPublicKey pk)
  {
    this.sk = sk;
    this.pk = pk;
  }
   ...
   */
  public ECCAccumulatorPrivateKey getPrivate()
  {
    return sk;
  }
   ...
   */
  public ECCAccumulatorPublicKey getPublic()
  {
    return pk;
  }
